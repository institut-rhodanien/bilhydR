#' Récupération de la date de floraison
#'
...
#' @param methode choisir entre plusieurs méthode d'estimation de la date de floraison ("GFV")
...
#'
#' @export
dateFloraison <- function(data, methode, cepage) {
